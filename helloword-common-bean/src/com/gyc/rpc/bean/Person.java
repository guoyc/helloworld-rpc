...
public class Person implements org.apache.thrift.TBase<Person, Person._Fields>, java.io.Serializable, Cloneable, Comparable<Person> {
  ...
  private static final org.apache.thrift.protocol.TField IS_MAN_FIELD_DESC = new org.apache.thrift.protocol.TField("is_man", org.apache.thrift.protocol.TType.BOOL, (short)3);
  ...
  public boolean is_man; // required

  /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    NAME((short)1, "name"),
    AGE((short)2, "age"),
    IS_MAN((short)3, "is_man");
  ...
  private static final int __IS_MAN_ISSET_ID = 1;
  ...
  static {
    ...
    tmpMap.put(_Fields.IS_MAN, new org.apache.thrift.meta_data.FieldMetaData("is_man", org.apache.thrift.TFieldRequirementType.DEFAULT, 
  ...
  public Person setIs_man(boolean is_man) {
    this.is_man = is_man;
    setIs_manIsSet(true);
    return this;
  }

  public void unsetIs_man() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __IS_MAN_ISSET_ID);
  }

  /** Returns true if field is_man is set (has been assigned a value) and false otherwise */
  public boolean isSetIs_man() {
    return EncodingUtils.testBit(__isset_bitfield, __IS_MAN_ISSET_ID);
  }

  public void setIs_manIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __IS_MAN_ISSET_ID, value);
  }
  ...
  public boolean equals(Person that) {
    ...
    boolean this_present_is_man = true;
    boolean that_present_is_man = true;
    if (this_present_is_man || that_present_is_man) {
      if (!(this_present_is_man && that_present_is_man))
        return false;
      if (this.is_man != that.is_man)
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_is_man = true;
    list.add(present_is_man);
    if (present_is_man)
      list.add(is_man);
  ...
  public int compareTo(Person other) {
    ...
    lastComparison = Boolean.valueOf(isSetIs_man()).compareTo(other.isSetIs_man());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIs_man()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.is_man, other.is_man);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class PersonStandardScheme extends StandardScheme<Person> {
        ...
        switch (schemeField.id) {
          ...
          case 3: // IS_MAN
            if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
              struct.is_man = iprot.readBool();
              struct.setIs_manIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Person struct) throws org.apache.thrift.TException {
      ...
      oprot.writeFieldEnd();
      oprot.writeFieldBegin(IS_MAN_FIELD_DESC);
      oprot.writeBool(struct.is_man);
      oprot.writeFieldEnd();
